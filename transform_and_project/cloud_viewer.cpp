...
main (int argc, char** argv)
{
    ...
    std::cout << "point: " << _point << std::endl;
...
*/
  ...
  Eigen::Vector3f tmp1 = (z_axis.cross(x_proj.normalized())).normalized();
  Eigen::Vector3f tmp2 = z_axis.normalized();
  ...
  pcl::transformPointCloud (*cloud, *transformed_cloud, transformation);
    ...
    _point = transformed_cloud->at(320, 240);

    std::cout << "point at transformed cloud: " << _point << std::endl;
